...
<script type="text/javascript">
    $(document).ready(function(){
        $("#checksoftwarelist").click(function(){
            $("#softwarecategorylist input").each(function(){
...
<div id="content">
    ...
    <form action="<?php echo current_url(); ?>" method="post" >
        <div id="tabs">
                ...
                <table cellspacing="2" cellpadding="3" border="0" width="100%" class="form">
                    <tbody>
                        <tr>
                            ...
                            <td class="fieldarea">
                                <input type="text" name="inventory_model_code" size="40" id="inventory_model_code" value="<?php echo $modelInfo->inventory_model_code; ?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="15%" class="fieldlabel">Inventory Model Name</td>
                            <td class="fieldarea"><input type="text" name="inventory_model_name" size="40" id="inventory_model_name" value="<?php echo $modelInfo->inventory_model_name; ?>"></td>
                        </tr>
                        <tr>
                            <td class="fieldlabel">Inventory Model Desc</td>
                            <td class="fieldarea">
                                <textarea tabindex="28" style="width:60%;" rows="4" name="long_description"><?php echo $modelInfo->long_description; ?></textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div id="hardware">
                    ...
                    <div class="demo">
                        ...
                        <ul id="sortable2" class='dropfalse'>
                            <?php
                            //var_dump($selectedSortlist);
                            foreach ($selectedSortlist as $sitem) {
                                echo "<li class='ui-state-default' id='{$sitem->category_id}'>{$sitem->category_name}</li>";
                            }
                            ;
                            ?>
                        </ul>
            ...
            <div id="tabs-3">
                <p><b>Software/information</b><input type="button" id="checksoftwarelist" name="checksoftwarelist" value="Select All" /></p>

                <table cellspacing="2" cellpadding="3" border="0" width="100%" class="form">
                    <tbody>
                        <tr><td width="15%" class="fieldlabel">
                                <table width="100%" id="softwarecategorylist">
                                    <tbody>
